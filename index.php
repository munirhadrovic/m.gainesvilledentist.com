...
<!--[if gt IE 9]><!--><html class="no-js" lang="en"><!--<![endif]-->
    <head>
        ...
        <title>Gentle Dental Care</title>
    ...
    <body id="page">
        ...
        <ul class="cb-slideshow">
            ...
            <li><span>Image 02</span><div><h3>Gentle Dental Care</h3></div></li>
            <li><span>Image 03</span><div><h3>Gentle Dental Care</h3></div></li>
            <li><span>Image 04</span><div><h3>Gentle Dental Care</h3></div></li>
            <li><span>Image 05</span><div><h3>Gentle Dental Care</h3></div></li>
            <li><span>Image 06</span><div><h3>Gentle Dental Care</h3></div></li>
        </ul>
        <div class="container">
            
            <header>
                <h1> <span>Gentle Dental Care</span></h1>
